...
FORCEINLINE float& Vector3::operator[](int32_t index)
{
	if (index == 0) {
		return x;
	}
...
FORCEINLINE float Vector3::operator[](int32_t index)const
{
	if (index == 0) {
		return x;
	}
...
FORCEINLINE float& Vector3::component(int32_t index)
{
	return (&x)[index];
}

FORCEINLINE float Vector3::component(int32_t index) const
{
	return (&x)[index];
}
