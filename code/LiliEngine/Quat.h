...
// inline functions
template<class U>
FORCEINLINE Quat math::Lerp(const Quat& a, const Quat& b, const U& alpha)
{
	return Quat::slerp(a, b, alpha);
}

template<class U>
FORCEINLINE Quat math::BiLerp(const Quat& p00, const Quat& p10, const Quat& p01, const Quat& p11, float fracX, float fracY)
{
	Quat result;
	result = Lerp(
...
template<class U>
FORCEINLINE Quat math::CubicInterp(const Quat& P0, const Quat& T0, const Quat& P1, const Quat& T1, const U& a)
{
