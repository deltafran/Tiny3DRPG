...
private:
	...
	bool UpdateUI(float time, float delta)
	{
		...
		ImGui::Begin("Debug GUI!", nullptr, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove);
	...
	void CreateMeshBuffers()
	{
		...
		m_IndexBuffer = VKIndexBuffer::Create(m_vulkanRHI->GetDevice(), cmdBuffer, indices);
